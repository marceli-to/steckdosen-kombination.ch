<section class="landing__intro">
  <article class="sm:grid">
    <figure class="sm:span-8 md:span-7">
      <img src="/assets/img/powerbox-v2.png" width="500" height="500" alt="MENNEKES Konfigurator">
      <a href="{{ route(app()->getLocale() . '.page.steckdosen-kombination.app') }}" class="btn-cta" title="{{ __('Konfigurator starten') }}">

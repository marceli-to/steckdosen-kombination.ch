    ...
    <a href="https://www.mennekes.ch/produkte/highlights/amaxx/" class="landing-tile landing-tile--mennekes sm:mr-8x" target="_blank">
      <span class="landing-tile__icon">
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <path d="M10.9061 17.6684V12.0993L3 20.9999H21V6.33136L10.9061 17.6684Z" fill="#D9073A"/>
          <path d="M3 3V17.6685L13.0442 6.33149V11.9006L21 3H3Z" fill="#D9073A"/>
        </svg>
      </span>
      <span class="landing-tile__text">
        ...
        <div class="flex items-center">
          ...
          <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M13.8785 2.22308L7.34134 8.83872" stroke="#D9073A" stroke-width="1.8561" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
            <path d="M10.0548 2H14V5.91889" stroke="#D9073A" stroke-width="1.8561" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
            <path d="M7.42064 3.74915H2V14.1839H12.4348L12.4346 8.7633" stroke="#D9073A" stroke-width="1.8561" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
          </svg>
        </div>
      </span>
    </a>
